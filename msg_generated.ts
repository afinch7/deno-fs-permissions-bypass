...
export enum Any{
  ...
  Exit= 11,
  Fetch= 12,
  FetchModuleMetaData= 13,
  FetchModuleMetaDataRes= 14,
  FetchRes= 15,
  FormatError= 16,
  FormatErrorRes= 17,
  GlobalTimer= 18,
  ...
  Truncate= 66,
  WorkerGetMessage= 67,
  WorkerGetMessageRes= 68,
  WorkerPostMessage= 69,
  Write= 70,
  WriteFile= 71,
  WriteRes= 72
};
 ...
 * @returns GlobalTimer
 */
static getRootAsGlobalTimer(bb:flatbuffers.ByteBuffer, obj?:GlobalTimer):GlobalTimer {
  return (obj || new GlobalTimer).__init(bb.readInt32(bb.position()) + bb.position(), bb);
};
...
static createGlobalTimer(builder:flatbuffers.Builder, timeout:number):flatbuffers.Offset {
 ...
 * @returns GlobalTimerRes
 */
static getRootAsGlobalTimerRes(bb:flatbuffers.ByteBuffer, obj?:GlobalTimerRes):GlobalTimerRes {
  return (obj || new GlobalTimerRes).__init(bb.readInt32(bb.position()) + bb.position(), bb);
};
...
static createGlobalTimerRes(builder:flatbuffers.Builder):flatbuffers.Offset {
 ...
 * @returns GlobalTimerStop
 */
static getRootAsGlobalTimerStop(bb:flatbuffers.ByteBuffer, obj?:GlobalTimerStop):GlobalTimerStop {
  return (obj || new GlobalTimerStop).__init(bb.readInt32(bb.position()) + bb.position(), bb);
};
...
static createGlobalTimerStop(builder:flatbuffers.Builder):flatbuffers.Offset {
 ...
 * @returns Permissions
 */
static getRootAsPermissions(bb:flatbuffers.ByteBuffer, obj?:Permissions):Permissions {
  return (obj || new Permissions).__init(bb.readInt32(bb.position()) + bb.position(), bb);
};
 ...
 * @returns PermissionRevoke
 */
static getRootAsPermissionRevoke(bb:flatbuffers.ByteBuffer, obj?:PermissionRevoke):PermissionRevoke {
  return (obj || new PermissionRevoke).__init(bb.readInt32(bb.position()) + bb.position(), bb);
};
...
static createPermissionRevoke(builder:flatbuffers.Builder, permissionOffset:flatbuffers.Offset):flatbuffers.Offset {
 ...
 * @returns PermissionsRes
 */
static getRootAsPermissionsRes(bb:flatbuffers.ByteBuffer, obj?:PermissionsRes):PermissionsRes {
  return (obj || new PermissionsRes).__init(bb.readInt32(bb.position()) + bb.position(), bb);
};
...
static createPermissionsRes(builder:flatbuffers.Builder, run:boolean, read:boolean, write:boolean, net:boolean, env:boolean):flatbuffers.Offset {
